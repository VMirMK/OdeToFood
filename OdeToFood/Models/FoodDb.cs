...
namespace OdeToFood.Models
{
    public class FoodDb
    {
        static FoodDb()
        {
            ...
            _reviews.Add(new RestaurantReview {Name = "Restoran", Rating = 6, Body = "aren", Created = DateTime.Now});
            _reviews.Add(new RestaurantReview {Name = "Gurmet", Rating = 10, Body = "super", Created = DateTime.Now});
